...
void main() {
  ...
  // Lava uses Minecraft-style face shading but with higher base brightness (emissive-like)
  ...
  // Lava is emissive, so we boost the shade to keep it brighter overall
  shade = mix(shade, 1.0, 0.6); // 60% towards full brightness
