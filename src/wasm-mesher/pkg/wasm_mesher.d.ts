 ...
 */
export function mesh_models_v3(grid_data: Uint8Array, light_data: Uint8Array, model_state_data: Uint8Array, min_chunk_x: number, min_chunk_z: number, max_chunk_x: number, max_chunk_z: number, lod_level: number): ModelMeshResultWasm;
...
export interface InitOutput {
    ...
    readonly mesh_models_v3: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => number;
