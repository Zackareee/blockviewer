 ...
 */
export function compute_state_hash(state_string: string): bigint;

/**
 * Compute multiple state hashes at once (more efficient for bulk operations)
 */
export function compute_state_hashes(state_strings: string): BigUint64Array;
 ...
 */
export function init_hash_model_registry(state_strings: string, geometry_data: Uint8Array): void;
 ...
 */
export function init_hash_model_registry_precomputed(state_hashes: BigUint64Array, geometry_data: Uint8Array): void;
 ...
 */
export function mesh_chunk_streaming(grid_data: Uint8Array, light_data: Uint8Array, chunk_x: number, chunk_z: number): StreamingMeshResultWasm;
