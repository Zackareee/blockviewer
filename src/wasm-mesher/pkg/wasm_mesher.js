 ...
 * @returns {ModelMeshResultWasm}
 */
export function mesh_models_v3(grid_data, light_data, model_state_data, min_chunk_x, min_chunk_z, max_chunk_x, max_chunk_z, lod_level) {
    const ptr0 = passArray8ToWasm0(grid_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(light_data, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.mesh_models_v3(ptr0, len0, ptr1, len1, ptr2, len2, min_chunk_x, min_chunk_z, max_chunk_x, max_chunk_z, lod_level);
    return ModelMeshResultWasm.__wrap(ret);
}
